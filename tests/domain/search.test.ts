...
describe('searchServices', () => {
  it('matches AC cooling keywords to AC Diagnostic', () => {
    const services = bookingRepository.listServices('biz_acme_hvac');
  ...
  it('matches haircut query for salon', () => {
    const services = bookingRepository.listServices('biz_northline_salon');

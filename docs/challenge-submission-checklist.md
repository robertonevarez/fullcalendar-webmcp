...
| Live HTTPS URL | Done | https://protocoltooling.vercel.app |
...
| Deployment URL on submission | Ready | https://protocoltooling.vercel.app |
...
1. Confirm ChatGPT in-app browser against https://protocoltooling.vercel.app (create → reload → get same appointment).
